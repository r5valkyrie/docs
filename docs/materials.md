...
The Titanfall 1's RE-45 Auto model is illustrated below, imported into Blender, using the Blender Source Tools plugin, after having decompiled the .MDL into a .QC and .SMDS, with Crowbar / Studiomdl  
