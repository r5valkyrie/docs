...
Note that vectors in R5Valkyrie / Apex Legends are 3-dimensional, not 2-dimensional (they have a 3rd axis, oZ or the Z axis).
...
Linear interpolation / Linear function graphing
