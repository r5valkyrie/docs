...
This article documents useful enumerations inside the code. These can be accessed from inside scripts.
...
global enum eStatusEffect  
{  
	area_loot_scan = 0  
	fireproof = 1  
	protection = 2  
	satellite_detected = 3  
	split_timeline = 4  
	placing_cover_wall = 5  
	spotter_sight = 6  
	rev_shell_targeted = 7  
	ring_flare = 8  
	cryonade = 9  
	rhapsody_tactical = 10  
	crypto_beacon_scan = 11  
	immune_to_abilities = 12  
	phase_gate_tracking = 13  
	turretlockon_detected = 14  
	titan_sword_fuel = 15  
	titan_sword_dash = 16  
	titan_sword_super = 17  
	titan_sword_dash_sickness = 18  
	player_carrying_oddball = 19  
	ring_immunity = 20  
	placing_respawn_beacon = 21  
	slowedbyCustomGrenade = 22  
	anti_slow = 23  
	move_slow = 24  
	turn_slow = 25  
	dodge_speed_slow = 26  
	...
	grapple_slow = 28  
	speed_boost = 29  
	stim_visual_effect = 30  
	timeshift_visual_effect = 31  
	enemy_only_threat_vision = 32  
	threat_vision = 33  
	gravity_grenade_visual = 34  
	sonar_pulse_visuals = 35  
	tracking_vision = 36  
	hunt_mode = 37  
	hunt_mode_visuals = 38  
	adrenaline_visuals = 39  
	gas_cloud = 40  
	gas_slow_protection = 41  
	shellshock = 42  
	burning = 43  
	phase_dash = 44  
	passive_cloak = 45  
	smokescreen = 46  
	marked_for_death = 47  
	revenge_view_visuals = 48  
	revenge_view_visuals_enemy = 49  
	mirage_ultimate_cancel_hint = 50  
	crypto_tt_scanned_visual = 51  
	laser_mesh = 52  
	destroyed_by_emp = 53  
	titan_damage_amp = 54  
	sonar_blocked = 55  
	...
	flamethrower = 64  
	frozencontrols = 65  
	smart_ammo_tracker_militia = 66  
	smart_ammo_tracker_imc = 67  
	smart_ammo_tracker_neutral = 68  
	smart_ammo_tracker_all = 69  
	placing_tesla_trap = 70  
	placing_trophy_system = 71  
	placing_phase_gate = 72  
	placing_phase_tunnel = 73  
	placing_caustic_barrel = 74  
	camera_view = 75  
	crypto_has_camera = 76  
	crypto_camera_is_recalling = 77  
	crypto_camera_is_emp = 78  
	crypto_emp_warning = 79  
	death_totem_visual_effect = 80  
	death_totem_recall = 81  
	silenced = 82  
	silenced_rev_visuals = 83  
	interrupted = 84  
	disable_wall_run = 85  
	disable_double_jump = 86  
	disable_automantle_hang = 87  
	script_helper = 88  
	pass_through_amps_weapon = 89  
	simple_timer = 90  
	minimap_jammed = 91  
	tethered = 92  
	battery_carried = 93  
	cockpitColor = 94  
	damageAmpFXOnly = 95  
	disable_wall_run_and_double_jump = 96  
	lockon_detected_titan = 97  
	damage_received_multiplier = 98  
	bombardment_uses_extended_height = 99  
	drone_healing = 100  
	phase_tunnel_visual = 101  
	pinged = 102  
	placing_care_package = 103  
	target_shields = 104  
	target_health = 105  
	trophy_tactical_charge = 106  
	trophy_shield_repair = 107  
	bubble_bunker = 108  
}  

global enum eWeaponBallisticType  
{  
	bolt = 0  
	hitscan = 1  
}  

global enum eWeaponCooldownType    
{  
	ammo = 0  
	ammo_instant = 1  
	ammo_deployed = 2  
...
global enum eWeaponFireMode  
{  
	automatic = 0 // usually for weapons  
	offhand = 1 // usually for abilities  
	offhandInstant = 2  
	offhandHybrid = 3  
	offhandMelee = 4  
	offhandMeleeHybrid = 5  
}  

global enum eWeaponVar  
{  
	printname = 1  
	shortprintname = 2  
	description = 3  
...
// Determines which position the weapon is shown on the player model, when holstered  

global enum eWeaponHolsterType  
{  
	defaultHolster = 0  
	rifle = 1  
	pistol = 2  
...
ePassivesglobal enum  
{  
	INVALID = -1,  

	// (dw): If you change this enum, it would be nice if you also updated itemtype_ability.rson  
	PAS_ADRENALINE,  
	PAS_ADS_SHIELD, // Gibraltar Gun Shield  
	PAS_FAST_HEAL,  
	PAS_GAS_GEAR, // Caustic  
	PAS_GAS_PROTECTION, // Caustic  
	PAS_MEDIC, // Lifeline  
	PAS_MIRAGE,  
	PAS_PATHFINDER,  
	PAS_STARTER_PACK,  
	PAS_TRACKING_VISION, // Bloodhound  
	PAS_VOICES, // Wraith  
	PAS_OCTANE,  
	PAS_CRYPTO,  
	PAS_GUARDIAN_ANGEL,  
	PAS_DEATHSTALKER,  
	PAS_BATTERY_POWERED, // Wattson  
	...
	PAS_SELF_REVIVE,  
	PAS_SYRINGE_BONUS,  
	PAS_FORTIFIED, // Fortified  
	PAS_LOWPROFILE, // Low Profile  
	PAS_PILOT_BLOOD,  
	PAS_DUMMIE,  
